    ...
    .then(function(_fresh) {
      ...
      if (fresh)
        ...
        .then(function() {
          ...
          preloadResolve(getDepMap(pjson));
          return fresh;
        });
      ...
      .then(function(cacheInfo) {
        ...
        if (endpoint.getPackageConfig)
          ...
          .then(function(_pjson) {
            preloadResolve(getDepMap(pjson = _pjson));
          });
