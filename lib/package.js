...
exports.locate = function(target) {
  ...
  .then(function() {
    return readJSON(path.resolve(registryPath, 'registry.json'));
  })
  .then(function(json) {
...
exports.checkOverride = function(pkg) {
  ...
  .then(function(files) {
    ...
    return readJSON(path.resolve(overrideDir, overrideFile))
    .catch(function(e) {
...
exports.download = function(pkg, jspmPackages, options, preload) {
  ...
  .then(function(_override) {
    ...
    .then(function(fresh) {
      ...
      .then(function(fresh) {
        ...
        .then(function() {
          return readJSON(path.resolve(downloadDir, 'package.json'));
        })
        .then(function(_pjson) {
          pjson = _pjson;
          return createMain(pkg, pjson, downloadDir);
        })
        .then(function() {
          return true;
        });
  ...
  .then(function(fresh) {
    ...
    .then(function(_pjson) {
      if (!pjson)
        return _pjson || readJSON(path.resolve(cacheDir, 'package.json'));
    })
    ...
    .then(function(_pjson) {
      ...
      if (endpoint.build)
        return endpoint.build(pjson, cacheDir);
    ...
    .then(function() {
      ...
      return build.buildPackage(cacheDir, pjsonObj);
    })

    // save the final calculated package.json in place
    .then(function() {
      return asp(fs.writeFile)(path.resolve(cacheDir, 'package.json'), JSON.stringify(pjson, null, 2))
    })
...
function createMain(pkg, pjson, downloadDir) {
