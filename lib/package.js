...
exports.getOverride = function(pkg, manualOverride) {
  // package.json override is primary override source
  // we use that extended with the manual override
  if (config.pjson.overrides[pkg.exactName]) {
  ...
  // otherwise use the registry + manual override
...
exports.download = function(pkg, options, installDeps) {
  ...
  .then(function(dirExists) {
    ...
    .then(function(pkgHash) {
      ...
      fullHash = hash + md5(JSON.stringify(options.override || {})) + endpoint.versionString + jspmVersion;
    ...
    .then(function(fresh) {
      ...
      if (options.linked) {
        ...
        .then(function(packageConfig) {
          return derivePackageConfig(pkg, packageConfig, options.override);
        }, function(err) {
          if (err)
        ...
        .then(function(packageConfig) {
          return processPackage(pkg, downloadDir, packageConfig, postloadResolve);
        })
        .then(function(packageConfig) {
      ...
      .then(function(cacheFresh) {
        ...
        .then(function(packageConfig) {
          return processPackage(pkg, cacheDir, packageConfig, postloadResolve);
        })
...
function processPackage(pkg, dir, packageConfig, postload) {
