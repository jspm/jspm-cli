...
exports.dlLoader = function(unminified, edge) {
  ...
  .then(function(lookup) {
    ...
    downloadFiles['/ModuleLoader/es6-module-loader/' + (edge ? '' : 'v') + lookup.version + '/dist/es6-module-loader' + min + '.js'] = 'es6-module-loader.js';
  ...
  .then(function(lookup) {
    ...
    downloadFiles['/systemjs/systemjs/' + lookup.version + '/dist/system' + min + '.js'] = 'system.js';
    return pkg.lookup(new Package('github:jmcriffey/bower-traceur@' + (!edge ? loaderVersions[2] : 'master')));
  })
  .then(function(lookup) {
    usedVersions[2] = lookup.version;
    downloadFiles['/jmcriffey/bower-traceur/' + lookup.version + '/traceur' + min + '.js'] = 'traceur.js';
    downloadFiles['/jmcriffey/bower-traceur-runtime/' + lookup.version + '/traceur-runtime' + min + '.js'] = 'traceur-runtime.js';
  })
  .then(function() {
    // delete old versions
    return asp(fs.readdir)(config.jspmPackages)
