...
exports.depCache = function(moduleName) {
  ...
  .then(function() {
    ...
    return systemBuilder.createTraceTree(moduleName, config.curConfig);
  })
...
exports.bundle = function(moduleName) {
  return config.load()
  .then(function() {
    config.main = moduleName || config.main;
    if (!moduleName)
      return cli.input('No main entry point is provided, please specify the module to build', '~/app').then(function(main) {
        config.main = main;
      });
  })
  .then(function() {
