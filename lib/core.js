...
exports.dlTranspiler = function(transpilerName) {
  return config.load()
  .then(function() {
    var installObj = {};
    ...
    if (target)
      ...
      installObj[transpilerName] = transpilerName == 'traceur' ? tPackages.traceur : tPackage.babel;
    ...
    return install.install(installObj, { quick: true, dev: true, summary: false });
  })
  .then(function() {
