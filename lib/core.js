...
var loaderVersions = ['0.8', '0.8', '0.0.56'];
      ...
      return new Promise(function(resolve, reject) {
        https.get({
          ...
          if (url.substr(0, 9) == '/systemjs')
            res = res.pipe(replacestream('"traceur.js"', !edge ? '\'traceur@' + usedVersions[2] + '.js\'' : '\'traceur.js\''))
            .pipe(replacestream('es6-module-loader.js', !edge ? 'es6-module-loader@' + usedVersions[0] + '.js' : 'es6-module-loader.js'))

          res.pipe(
            fs.createWriteStream(path.resolve(config.jspmPackages, filename))
            .on('finish', function() {
