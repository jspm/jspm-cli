...
exports.simpleBundle = function(moduleName, fileName) {
...
exports.arithmeticBundle = function(args) {
    var fileNameSpecified = (args.length - 2) % 2 === 1;
...
exports.bundle = function() {
  ...
  if (args.length < 2) {
      ...
      var moduleName = args[1];
      var fileName = args[2];
      return this.simpleBundle(moduleName, fileName);
  } else {
      return this.arithmeticBundle(args);
  }
}
