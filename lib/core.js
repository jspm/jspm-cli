...
exports.bundleUp = function(moduleName, fileName) {
    return config.load()
      .then(function() {
...
exports.transform = function(operations) {
...
exports.bundleDown = function(args) {
      var moduleName = args[1];
      var fileName = args[args.length - 1]; //not yet a standard...
      var operations = this.extract(args);
      var items = this.transform(operations);
...
exports.bundle = function(moduleName, fileName) {
  var moduleName, fileName, args = arguments[0];
  ...
  if (args.length < 2) {
      ...
      return this.bundleUp(moduleName, fileName);
  } else {
      return this.bundleDown(args);
  }
}
