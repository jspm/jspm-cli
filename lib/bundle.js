...
exports.bundle = function(moduleExpression, fileName, inject, sourceMaps) {
  inject = inject || false;
  ...
  .then(function(buildTree) {
    ...
    return systemBuilder.buildTree(buildTree, fileName, sourceMaps);
  })
  .then(function() {
...
exports.bundleSFX = function(moduleName, fileName, sourceMaps) {
  sourceMaps = !!sourceMaps;
  ...
  .then(function() {
    ...
    return systemBuilder.buildSFX(moduleName, cfg, fileName, sourceMaps);
  })
  .then(config.save)
  .then(function() {
