...
exports.bundle = function(moduleExpression, fileName, opts) {
  ...
  .then(function(output) {
    ...
    if (opts.inject) {
      ...
      var bundleName = extractBundleName(fileName, systemBuilder);
...
function extractBundleName(fileName, builder) {
  var file = path.resolve(config.pjson.baseURL, fileName).replace(/\\/g, '/');
  return builder.getCanonicalName(toFileURL(file)); 
}
