...
exports.buildPackage = function(dir, pjson, sourceURLBase) {
...
function inDir(fileName, dir) {
  return fileName.substr(0, dir.length) == dir && fileName.substr(dir.length - 1, 1) == path.sep;
}
  ...
  .then(function(allFiles) {
    ...
    allFiles.forEach(function(file) {
      ...
      if (files && !files.some(function(keepFile) {
        ...
        if (inDir(fileName, keepFile) || minimatch(fileName, keepFile))
          return true;
      }))
    ...
    return Promise.all(files.map(function(file) {
      ...
      .then(function(source) {
        ...
        .then(function() {
          ...
          if (curShim.exports)
            depStr += '"export ' + curShim.exports + '";' + nl;
        ...
        .then(function() {
          ...
          try {
            ...
            var parser = new traceur.syntax.Parser(new traceur.syntax.SourceFile(relFile, source), reporter);
            ...
            var sourceMapGenerator = new traceur.outputgeneration.SourceMapGenerator({ file: path.basename(relFile.replace(/\.js$/, '.src.js')) });
        ...
        .then(function() {
          ...
          .then(function() {
            return asp(fs.writeFile)(file, source + '\n//# sourceMappingURL=' + options.sourceURLBase + '/' + relFile + '.map');
          })
