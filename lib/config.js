...
exports.load = function(prompts) {
  ...
  .then(function(depsJSON) {
    ...
    ui.log('warn', 'This is an alpha release of jspm 0.17, there may well be upgrade bugs.');
    return ui.confirm('jspm will now upgrade your project to the 0.17 configuration. Are you sure you want to proceed?', true)
