...
exports.load = function(prompts) {
  ...
  .then(function() {
    ...
    ui.log('info', '%Upgrading project to jspm 0.17...%');
    ui.log('info', 'All overrides are being checked into the package.json file to ensure full reproducibility.');
    ...
    .then(function() {
      ui.log('ok', 'jspm 0.17 upgrade complete.');
      ui.log('info', 'Run %jspm install% to upgrade all individual packages.');
    });
  })
  .then(function() {
