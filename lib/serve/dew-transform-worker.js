...
let curSource, curAst, curFilename, curProduction, browserTargets;
        ...
        case 'analyze-esm':
            try {
                ...
                if (err instanceof SyntaxError && err.loc)
                    process.send({ type: 'syntax-error', data: { loc: err.loc, msg: err.message } });
                else
...
//# sourceMappingURL=dew-transform-worker.js.map