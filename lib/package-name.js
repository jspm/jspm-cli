...
Package.prototype.getPath = function(packagesFolder) {
  ...
  return path.resolve(packagesFolder || config.pjson.packages, this.registry, this.exactPackage.replace(/[\/%]/g, function(symbol) {
    return encodeURIComponent(symbol);
  }));
};

Package.prototype.toString = function() {
  return this.name + '@' + (this.version ? this.version.replace(/[\/%]/g, function(symbol) {
    return encodeURIComponent(symbol);
  }) : '');
};
