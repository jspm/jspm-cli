export declare function relativeResolve(require: any, filePath: any, pkgBasePath: any, files: any, folderMains: any): any;
...
export declare function toDew(path: string, checkMain?: boolean): string;
