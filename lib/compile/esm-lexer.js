...
exports.analyzeModuleSyntax = analyzeModuleSyntax;
// State:
// (for perf, works because this runs sync)
let i, charCode, str, lastTokenIndex, lastOpenTokenIndex, lastTokenIndexStack, braceDepth, templateDepth, templateStack, oImports, oExports;
function baseParse() {
...
exports.singleQuoteString = singleQuoteString;
...
exports.doubleQuoteString = doubleQuoteString;
...
exports.regexCharacterClass = regexCharacterClass;
...
exports.readPrecedingKeyword = readPrecedingKeyword;
...
exports.readToWsOrPunctuator = readToWsOrPunctuator;
...
exports.isExpressionKeyword = isExpressionKeyword;
...
exports.isParenKeyword = isParenKeyword;
...
exports.isExpressionPunctuator = isExpressionPunctuator;
...
//# sourceMappingURL=esm-lexer.js.map