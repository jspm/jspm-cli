...
Config.prototype.read = function(prompts) {
  ...
  .then(function(cfg) {
    ...
    self.parser = cfg.parser || 'traceur';
  })
  .then(function() {
    return Promise.resolve(prompts ? ui.input('Which ES6 transpiler would you like to use, %Traceur% or %6to5%?', self.parser) : self.parser)
