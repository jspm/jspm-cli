...
Config.prototype.read = function(prompts, sync) {
  ...
  .then(function(useTranspiler) {
    ...
    return ui.input('Which ES6 transpiler would you like to use, %Traceur%, %Babel% or %TypeScript%?'
        + '\n(TypeScript does not yet have bundling support in jspm)', self.transpiler);
  })
