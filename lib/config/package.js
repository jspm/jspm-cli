...
PackageConfig.prototype.populateDefaultPaths = function(forceValidDefaults) {
  ...
  this.hasLib = typeof libValue == 'string';
  this.lib = this.hasLib ? libValue || '.' : (libValue ? path.resolve(this.dir, libValue) : path.resolve(this.baseURL, 'src'));
  ...
  this.dist = typeof distValue == 'string' ? path.resolve(this.dir, distValue) : path.resolve(this.baseURL, 'dist');
  ...
  this.packages = typeof packagesValue == 'string' ? path.resolve(this.dir, packagesValue) : path.resolve(this.baseURL, 'jspm_packages');
  ...
  // these are only created when explicitly opting in
  this.configFileDev = prefixedGetValue.call(this, ['configFiles', 'jspm:dev'], 'string') || path.dirname(this.configFile) + path.sep + 'jspm.dev.js';
  this.configFileBrowser = prefixedGetValue.call(this, ['configFiles', 'jspm:browser'], 'string') || path.dirname(this.configFile) + path.sep + 'jspm.browser.js';
  this.configFileNode = prefixedGetValue.call(this, ['configFiles', 'jspm:node'], 'string') || path.dirname(this.configFile) + path.sep + 'jspm.node.js';
