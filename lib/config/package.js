...
PackageConfig.prototype.populateDefaultPaths = function(forceValidDefaults) {
  ...
  this.configFileDev = prefixedGetValue.call(this, ['configFiles', 'jspm:dev'], 'string');
  this.configFileBrowser = prefixedGetValue.call(this, ['configFiles', 'jspm:browser'], 'string');
  this.configFileNode = prefixedGetValue.call(this, ['configFiles', 'jspm:node'], 'string');
...
PackageConfig.prototype.write = function() {
  ...
  if (this.configFileDev)
    prefixedSetValue.call(this, ['configFiles', 'jspm:dev'], toRelativePath.call(this, this.configFileDev));
  else
    this.file.remove(['jspm', 'configFiles', 'jspm:dev']) && this.file.remove(['configFiles', 'jspm:dev']);

  if (this.configFileBrowser)
    prefixedSetValue.call(this, ['configFiles', 'jspm:browser'], toRelativePath.call(this, this.configFileBrowser));
  else
    this.file.remove(['jspm', 'configFiles', 'jspm:browser']) && this.file.remove(['configFiles', 'jspm:browser']);

  if (this.configFileNode)
    prefixedSetValue.call(this, ['configFiles', 'jspm:node'], toRelativePath.call(this, this.configFileNode));
  else
