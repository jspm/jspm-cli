...
PackageConfig.prototype.populateDefaultPaths = function(forceValidDefaults) {
  ...
  this.configFileDev = prefixedGetValue.call(this, ['configFiles', 'browser'], 'string') || path.resolve(path.dirname(this.configFile), 'jspm.dev.js');
  ...
  if (config.loaderDev)
    config.loaderBrowser.file.rename(this.configFileDev);
};
...
PackageConfig.prototype.write = function() {
  ...
  prefixedSetValue.call(this, ['configFiles', 'jspm:dev'], toRelativePath.call(this, this.configFileDev), baseURLPath + 'jspm.dev.js');
