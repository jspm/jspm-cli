...
PackageJSON.prototype.allDependencies = function() {
  ...
  Object.keys(self.dependencies).forEach(function(dep) {
    allDependencies[dep] = self.dependencies[dep];
  });
  Object.keys(self.devDependencies).forEach(function(dep) {
    allDependencies[dep] = self.devDependencies[dep];
  });
...
PackageJSON.prototype.write = function() {
  ...
  if (!hasProperties(pjson.devDependencies))
