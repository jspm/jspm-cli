...
PackageJSON.prototype.write = function() {
  ...
  if (!hasProperties(pjson.dependencies) && !this.jspmPrefix || !this.originalPjson.dependencies)
    delete pjson.dependencies;

  pjson.devDependencies = writeDependencies(this.devDependencies, this.registry);
  if (!hasProperties(pjson.devDependencies) && !this.jspmPrefix || !this.originalPjson.dependencies)
