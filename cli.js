  ...
  switch(args[0]) {
    ...
    case 'bundle':
      options = readOptions(args, ['inject', 'yes', 'skip-source-maps', 'minify',
          'no-mangle', 'hires-source-maps', 'no-runtime', 'inline-source-maps', 'source-map-contents', 'browser', 'node', 'skip-encode-names'], ['format', 'global-name', 'globals', 'global-deps', 'global-defs']);
